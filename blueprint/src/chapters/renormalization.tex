...
NeuralNetwork.swish, NeuralNetwork.gaussianErf, NeuralNetwork.gelu}
Define
\begin{align*}
...
NeuralNetwork.gelu_eq_erf, NeuralNetwork.tendsto_logistic_atTop,
...
The exact exponential, logistic--tanh, and CDF--error-function identities all hold.
Every informal approximation in the activation section is represented by a Tendsto statement.
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section ``Function Approximation'' (\texttt{sec:MLP_intro}), especially
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section \texttt{sec:MLP_intro}, the affine neuron formula
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section \texttt{sec:MLP_intro}, the recursive network equations
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section ``Function Approximation'' (\texttt{sec:MLP_intro}), beginning
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section ``Function Approximation'' (\texttt{sec:MLP_intro}), in the
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section ``Function Approximation'' (\texttt{sec:MLP_intro}) for the
dataset and sample-index conventions, together with Section ``Ensembles''
(\texttt{sec:MLP_distribution}), subsection ``Induced distributions'', where the output array is
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section \texttt{sec:MLP_distribution}, the zero-initialization and
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section ``Function Approximation'' (\texttt{sec:MLP_intro}), in the CNN
...
\lean{NeuralNetwork.Conv2DLayer.preactivation_shift}
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section \texttt{sec:MLP_intro}, the CNN discussion containing
...
(\texttt{sec:MLP_distribution}), especially the generic model in
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section ``Ensembles'' (\texttt{sec:MLP_distribution}), subsection
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section \texttt{sec:MLP_distribution}, subsection ``Induced
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section ``Ensembles'' (\texttt{sec:MLP_distribution}), subsections
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section \texttt{sec:MLP_distribution}, subsection ``Deterministic
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section \texttt{sec:MLP_distribution}, the self-averaging footnote
...
\lean{NeuralNetwork.tendsto_gaussianProbabilityMeasure_zero_variance,
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section \texttt{sec:MLP_distribution}, equations
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section \texttt{sec:MLP_distribution}, subsection ``Initialization
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section ``Ensembles'' (\texttt{sec:MLP_distribution}).  It combines the
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section \texttt{sec:MLP_distribution}; it combines the layerwise
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section ``Ensembles'' (\texttt{sec:MLP_distribution}), obtained by
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section \texttt{sec:MLP_distribution}; the covariance is derived from
...
\paragraph{Source in \texttt{Renormalization.md}.}
Chapter ``Neural Networks'', Section \texttt{sec:MLP_distribution}, the one-layer induced law
...
\lean{NeuralNetwork.randomLayerKernel, NeuralNetwork.randomLayerKernel_apply}
...
\subsubsection*{Chapter~2 statement status (2026-08-02)}
The statement-level library is now present in seven modules:
\begin{enumerate}
  \item \texttt{Activation.lean} contains every activation display, exact identities, smoothness,
    origin values, asymptotic limits, and the corrected homogeneity classification.
...
activations and exports the true negated statement.  Statement completeness is separate from proof
completeness: every deferred proof has an informal argument and a source.

\subsubsection*{Source-equation coverage}
The matching \texttt{APIAudit.lean} mechanically checks every declaration below.
\begin{itemize}
