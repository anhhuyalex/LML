...
Complete.  \texttt{RenormalizationAPIAudit.lean} imports the direct target modules and checks every
external declaration currently named by this blueprint.  It compiles with
\texttt{lake env lean RenormalizationAPIAudit.lean}.  The verified combinatorial names are recorded
...
and \texttt{RenormalizationFinpartitionTest.lean} verifies the Bell counts $1,1,2,15$ in
