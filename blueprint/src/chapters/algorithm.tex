...
\begin{definition}[History]\label{def:history}
  \leanok
  \lean{Learning.history, Learning.step}
...
\begin{lemma}\label{lem:IsAlgEnvSeq.adapted}
  ...
  \leanok
  \lean{Learning.IsAlgEnvSeq.adapted_step, Learning.IsAlgEnvSeq.adapted_history, Learning.IsAlgEnvSeq.adapted_action, Learning.IsAlgEnvSeq.adapted_feedback}
...
\begin{lemma}\label{lem:condIndepFun_reward_hist_action}
  ...
  \leanok
  \lean{Learning.IsAlgEnvSeq.condIndepFun_feedback_history_action}
